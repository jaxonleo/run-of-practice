-- Pre-Practice Warmup text needs to reach the anonymous /preview/:token
-- screen too, not just the signed-in coach's Practice Setup -- same
-- pre_practice_notes column (20260813150000), just one more field on this
-- RPC's existing top-level jsonb_build_object. No other change from the
-- prior version (20260805050000_preview_view_setup_stage.sql).
