-- jersey_number isn't identity-sensitive (it's visible on the uniform) --
-- same category as the equipment/coaching-points/location detail restored
-- in migration 20260707210000, just missed on the first pass since group
-- members were built before that decision. Matches the #<jersey> <name>
-- chip convention already used everywhere on the coach-authenticated side.
