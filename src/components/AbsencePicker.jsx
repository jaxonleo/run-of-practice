  ...
  return (<div className="movly" onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
    <div className="modal">
      {mode === "pickPlayerThenPractices" && step === "team" && <div>
        ...
        <div style={{ fontSize: 13, color: "var(--text-dim)", marginBottom: 12 }}>Which team?</div>
      ...
      {mode === "pickPlayerThenPractices" && step === "player" && <div>
        <div style={{ fontFamily: "Barlow Condensed,sans-serif", fontSize: 20, fontWeight: 900, marginBottom: 12 }}>Who's out?</div>
        {allPlayers.length === 0 && <div style={{ fontSize: 13, color: "var(--text-dim)", marginBottom: 12 }}>No players yet.</div>}
        <div style={{ maxHeight: 320, overflowY: "auto" }}>
      ...
      {mode === "pickPlayerThenPractices" && step === "practices" && <div>
        ...
        {player && <div style={{ fontSize: 13, color: "var(--text-dim)", marginBottom: 12 }}>{player.firstName} {player.lastName}</div>}
        {candidatePractices.length === 0 && <div style={{ fontSize: 13, color: "var(--text-dim)", marginBottom: 12 }}>No upcoming practices scheduled.</div>}
        <div style={{ maxHeight: 320, overflowY: "auto" }}>
      ...
      {mode === "pickPlayersForPractice" && <div>
        <div style={{ fontFamily: "Barlow Condensed,sans-serif", fontSize: 20, fontWeight: 900, marginBottom: 12 }}>Who's out?</div>
        {(!team || team.players.length === 0) && <div style={{ fontSize: 13, color: "var(--text-dim)", marginBottom: 12 }}>No players on this team.</div>}
        <div style={{ maxHeight: 320, overflowY: "auto" }}>
